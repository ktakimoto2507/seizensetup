      ...
      <Card>
        ...
        <CardContent className="space-y-6">
              ...
              {(["driver","myNumber","passport"] as DocType[]).map((t) => (
                <button
                  ...
                  className={`border rounded px-3 py-2 ${
                    docType === t ? "border-green-600" : "border-gray-300"
                  }`}
                >
          ...
          <div>
            ...
            {frontURL && (
              <div className="mt-2">
                <img src={frontURL} alt="front preview" className="max-h-40 rounded border" />
              </div>
            )}
          </div>
          ...
          {backNeeded && (
            <div>
              ...
              {backURL && (
                <div className="mt-2">
                  <img src={backURL} alt="back preview" className="max-h-40 rounded border" />
                </div>
              )}
            </div>
          )}
          ...
          <div>
            ...
            {selfieURL && (
              <div className="mt-2">
                <img src={selfieURL} alt="selfie preview" className="max-h-40 rounded border" />
              </div>
            )}
            <p className="text-xs text-gray-500 mt-1">
